        ...
        while i < MEMORY {
            ...
            for j in 0..10 {
                unsafe {
                    ...
                    sub_and_shift_and_mix_add_round_in_place(text_ptr.offset(0x10) as *mut u32, exp_ptr);
                    sub_and_shift_and_mix_add_round_in_place(text_ptr.offset(0x20) as *mut u32, exp_ptr);
                    sub_and_shift_and_mix_add_round_in_place(text_ptr.offset(0x30) as *mut u32, exp_ptr);
                    sub_and_shift_and_mix_add_round_in_place(text_ptr.offset(0x40) as *mut u32, exp_ptr);
                    sub_and_shift_and_mix_add_round_in_place(text_ptr.offset(0x50) as *mut u32, exp_ptr);
                    sub_and_shift_and_mix_add_round_in_place(text_ptr.offset(0x60) as *mut u32, exp_ptr);
